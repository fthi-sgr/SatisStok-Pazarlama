...
public class Yetkiler_Dal<YetkilerContract> extends ObjectHelper implements DALInterfaces<YetkilerContract>{
    ...
    @Override
    public YetkilerContract UpdateT(YetkilerContract entiy) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
