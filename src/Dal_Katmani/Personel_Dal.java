...
class Personel_Dal<PersonelContract> extends ObjectHelper implements DALInterfaces<PersonelContract>{
    ...
    @Override
    public PersonelContract UpdateT(PersonelContract entiy) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
