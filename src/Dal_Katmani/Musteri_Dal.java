...
public class Musteri_Dal<MusteriContract> extends ObjectHelper implements DALInterfaces<MusteriContract>{
    ...
    @Override
    public MusteriContract UpdateT(MusteriContract entiy) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
